...
export async function POST(request: Request) {
  ...
  try {
    ...
    // CORREÇÃO 1: O mimeType agora fica dentro de "config"
    ...
    // CORREÇÃO 2: Adicionamos "!" para afirmar ao TypeScript que o nome e a URI existem
    ...
    // CORREÇÃO 3: Convertendo para ArrayBuffer que é o tipo que o NextResponse aceita
